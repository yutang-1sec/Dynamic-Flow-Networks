...
# Initialize 101 cells (initial density from 0 to 100).
numCell = 101
initialDens = np.linspace(0, 100, 101)
...
plt.plot([50, 60], [0, 20], color="red", linestyle="dashed")
