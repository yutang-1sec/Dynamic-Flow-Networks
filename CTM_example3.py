...
# Initialize 151 cells (initial density from 0 to 150).
numCell = 151
initialDens = np.linspace(0, 150, 151)
...
plt.plot([50, 75], [0, 50], color="red", linestyle="dashed")
plt.plot([100, 75],[0, 50], color="red", linestyle="dashed")
plt.plot([75, 75], [50, 60], color="red", linestyle="dashed")
